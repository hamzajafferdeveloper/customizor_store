          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:8px; padding:0;">
            ...
            <tr>
              <td align="center" bgcolor="#000000" style="padding:15px; border-radius:8px 8px 0 0;">
                <h1 style="margin:0; font-size:22px; color:#ffffff; text-align:center;">Plan Upgraded Successfully</h1>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:20px; line-height:1.6; color:#000000; font-size:16px;">
                ...
                <p style="margin-bottom:15px;">We’re excited to inform you that your subscription plan has been successfully upgraded!</p>
                ...
                <p style="margin-bottom:0;">Thank you for upgrading and trusting us!</p>
              </td>
            </tr>
