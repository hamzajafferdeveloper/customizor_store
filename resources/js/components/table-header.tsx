...
export default function TableHeaderCustom({ searchValue, setSearchValue, btnText, btnType, btnlink, searchTxt, btnFunc, heading, desc, desc2 }: Props) {
    return (
        <header className="w-full">
            ...
            <div className="flex items-center rounded-lg border w-1/2 shadow">
