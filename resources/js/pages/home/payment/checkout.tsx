...
function PaymentForm({ plan }: { plan: Plan }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (result.error) {
            ...
            router.post(route('payment.confirmation', { plan: plan }));
    ...
    return (
        <div className="mx-auto w-full max-w-md rounded-xl bg-white p-6 shadow-lg dark:bg-gray-900">
            <h1 className="mb-2 text-center text-3xl font-extrabold text-gray-900 dark:text-white">Complete Your Payment</h1>
