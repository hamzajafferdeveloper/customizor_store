...
export default function CreateFontModal({ open, onOpenChange }: Props) {
    ...
    const submit: FormEventHandler = async (e) => {
        ...
        post(route('superadmin.fonts.store'), {
            // @ts-expect-error
            data: formData,
            forceFormData: true,
            onSuccess: () => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Store Font</DialogTitle>
                    <DialogDescription>Enter the font name and upload an font file.</DialogDescription>
                </DialogHeader>
